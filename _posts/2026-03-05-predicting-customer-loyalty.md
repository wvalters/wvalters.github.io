...
In this project we look to fill in missing customer loyaltu scores in our dataset. Only around 50% of the existing records had that data, thus the other half did not have this information present. 
