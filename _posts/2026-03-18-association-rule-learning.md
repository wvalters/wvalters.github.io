...
As this is first & foremost an exploratory project, we will take back the results to the client Category Managers & discuss the results, our views on how these insights can be actioned the best, and any considerations that need to be taken into account when interpreting.
...
As this was first & foremost an exploratory project, we will take back the results to the client Category Managers & discuss the results, our views on how these insights can be actioned the best, and any considerations that need to be taken into account when interpreting.
